...
// Constants borrowed from <bluetooth/hci.h> BlueZ include file
...
module.exports = Object.freeze({
  ...
  HCI_MAX_FRAME_SIZE: 1492 + 4 + 4, // HCI_MAX_ACL_SIZE + 4
  ...
  // LE role
  LE_ROLE_CENTRAL: 0x00,
  LE_ROLE_PERIPHERAL: 0x01,
  ...
  // HCI Advertising PDU Type
  LE_META_EVENT_TYPE_ADV_IND: 0b0000, // Connectable undirected advertising event (0x00)
  LE_META_EVENT_TYPE_ADV_DIRECT_IND: 0b0001, // Connectable directed advertising event (0x01)
  LE_META_EVENT_TYPE_ADV_NONCONN_IND: 0b0010, // Non-connectable undirected advertising event (0x02)
  LE_META_EVENT_TYPE_SCAN_REQ: 0b0011, // Scan request (0x03)
  LE_META_EVENT_TYPE_SCAN_RSP: 0b0100, // Scan response (0x04)
  LE_META_EVENT_TYPE_CONNECT_REQ: 0b0101, // Connection request (0x05)
  LE_META_EVENT_TYPE_ADV_SCAN_IND: 0b0110, // Scannable undirected advertising event (0x06)

  // HCI Extended Advertising PDU Mask
  LE_META_EXTENDED_EVENT_TYPE_CONNECTABLE_MASK: 0x01,
  LE_META_EXTENDED_EVENT_TYPE_SCANNABLE_MASK: 0x02,
  LE_META_EXTENDED_EVENT_TYPE_SCAN_RESPONSE_MASK: 0x08,
  LE_META_EXTENDED_EVENT_TYPE_INCOMPLETE_MASK: 0x20,
  ...
  SCO_PTYPE_MASK: 0x00e0, // (HCI_HV1 | HCI_HV2 | HCI_HV3)
  ACL_PTYPE_MASK: 0xcc18, // (HCI_DM1 | HCI_DH1 | HCI_DM3 | HCI_DH3 | HCI_DM5 | HCI_DH5)
  ...
  // ACL PB Flags (Packet Boundary Flag)
  ACL_START_NO_FLUSH: 0x00, // First non-automatically-flushable packet of Higher Layer Message from Host to Controller. Start of a non-automatically-flushable L2CAP PDU.
  ACL_CONT: 0x01, // Continuing fragment of Higher Layer Message.
  ACL_START: 0x02, // First automatically flushable packet of Higher Layer Message. Start of an automatically-flushable L2CAP PDU.
  ACL_COMPLETE: 0x03, // A complete L2CAP PDU. Automatically flushable.

  // ACL BP Flags (Broadcast Flag)
  ACL_ACTIVE_BCAST: 0x04, // Active Slave Broadcast: packet is sent to all active slaves
  ACL_PICO_BCAST: 0x08, // Parked Slave Broadcast: packet is sent to all slaves and all slaves in park state
  ...
  OCF_LE_CLEAR_RESOLV_LIST: 0x0029,
  ...
  OCF_LE_CREATE_EXTENDED_CONN: 0x0043,
